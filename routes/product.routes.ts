...
ProductRouter.post("/create_product",authMiddleware,adminMiddleware, createProduct)
ProductRouter.put("/update_product/:id",authMiddleware,adminMiddleware,updateProduct)
